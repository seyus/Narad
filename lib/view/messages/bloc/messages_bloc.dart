...
class MessagesBloc extends Bloc<MessagesEvent, MessagesState> {
  ...
  Stream<MessagesState> currentlyListeningEvent(CurrentlyListening event) async* {
        await storageRepository.currentlyListening(
            song: event.song, userId: userId, friendId: event.friendId);
  }
